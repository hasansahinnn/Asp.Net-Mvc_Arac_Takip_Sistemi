    ...
    DateRangePicker.prototype = {
        ...
        calculateChosenLabel: function () {
            ...
            for (var range in this.ranges) {
              if (this.timePicker) {
                    ...
                    if (this.startDate.format('YYYY-DD-MM') == this.ranges[range][0].format('YYYY-DD-MM') && this.endDate.format('YYYY-DD-MM') == this.ranges[range][1].format('YYYY-DD-MM')) {
                        customRange = false;
                        this.chosenLabel = this.container.find('.ranges li:eq(' + i + ')').addClass('active').attr('data-range-key');
                        break;
                    }
        ...
        timeChanged: function(e) {
            ...
            if (isLeft) {
                ...
                if (this.singleDatePicker) {
                    this.endDate = this.startDate.clone();
                } else if (this.endDate && this.endDate.format('YYYY-DD-MM') == start.format('YYYY-DD-MM') && this.endDate.isBefore(start)) {
